...
class TestConnectionService {
  static Future<void> testServerConnection() async {
    ...
    List<String> urlsToTest = [
      'http://192.168.11.102:8000',  // IP réseau local (priorité)
      'http://127.0.0.1:8000',
      'http://10.0.2.2:8000',
      'http://localhost:8000',
    ];
    ...
    List<String> imageUrls = [
      'http://192.168.11.102:8000/storage/images/582124d2-3f85-47f1-800f-12fc1e015ab9.png',
      'http://192.168.11.102:8000/storage/images/fc582a90-48a6-40d9-8db5-41703729f85f.png',
      'http://192.168.11.102:8000/storage/universities/1735222978_IMG_0096.JPG',
